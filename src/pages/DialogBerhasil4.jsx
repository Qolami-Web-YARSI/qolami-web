...
const DialogBerhasil4 = ({id}) => {
    ...
    return(
        <>
            <div className="modal fade" id={`dialogMulaiUjian${id}`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div className="modal-body tw-px-[50px] tw-rounded-[25px] tw-bg-[#FFF6D9]">
                            <div className="tw-flex tw-flex-col tw-gap-6 tw-py-5">
                                <div className="tw-flex tw-bg-[#DBF9F9] tw-border-[3px] tw-border-[#81DEDF] tw-rounded-[23px] tw-py-10 tw-px-12">
                                    <p className="tw-mx-auto sm:tw-text-[20px] lg:tw-text-[23px] tw-text-[#628478]">Apakah Anda yakin ingin memulai ujian?</p>
                                </div>
