                    ...
                    <div className="modal-content tw-rounded-[25px]">
                        <div className="modal-body tw-px-[50px] tw-rounded-[25px] tw-bg-[#FFF6D9]">
                            <div className="tw-flex tw-flex-col tw-gap-6 tw-py-5">
                                ...
                                <button type="button" className="btn btn-secondary tw-text-[23px] tw-bg-[#458200] hover:tw-bg-[#009900] tw-text-white tw-w-[100px] tw-mx-auto tw-rounded-[30px] tw-font-bold" onClick={()=> window.location.reload()} data-bs-dismiss="modal">OK</button>
                            </div>
                        </div>
                    </div>
                </div>
