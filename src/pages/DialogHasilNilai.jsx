                    ...
                    <div className="modal-content tw-w-[600px] tw-bg-[#FFF6D9] tw-py-2 tw-rounded-[25px] tw-mx-auto">
                        <div className="tw-flex tw-flex-col modal-body tw-px-[50px] tw-rounded-[25px] tw-bg-[#FFF6D9] tw-font-poppins">
                            ...
                            <div className="tw-flex tw-gap-6 tw-pt-8 tw-mx-auto tw-w-full">
                                ...
                                <div className='tw-flex tw-w-1/2 tw-flex-col tw-mx-auto'>
                                    <p className={`tw-mx-auto tw-font-bold tw-text-[25px] ${isGraduate === true ? 'tw-text-[#34D399]' : 'tw-text-[#FB7185]'}`}>Nilai</p>
                                    <p className={`tw-mx-auto tw-font-bold tw-text-[70px] ${isGraduate === true ? 'tw-text-[#34D399]' : 'tw-text-[#FB7185]'}`}>{score}</p>
                                </div>
                            </div>
                            <p className='tw-mx-auto tw-py-5 tw-pb-7 tw-text-[20px] tw-text-center'>{isGraduate === true ? 'Selamat! Anda telah Lulus dari latihan ini' : 'Nilai Anda belum memenuhi batas minimum yang ditentukan pada latihan ini: 75'}</p>
