                ...
                <div class="modal-body tw-px-[50px] tw-bg-[#FFF6D9] tw-rounded-[15px]">
                  ...
                  <button type="button" class="tw-bg-white tw-border-2 tw-rounded-lg tw-border-[#FF0000] tw-size-10 tw-opacity-0" disabled>
                    ...
                    <div class="tw-flex tw-flex-col tw-justify-center">
                      <p class="tw-text-[#458200] tw-text-xl">UBAH PASSWORD</p>
                    </div>
                  ...
                  <div class="tw-flex tw-w-full tw-flex-col tw-py-2">
                    ...
                    <div class="tw-flex tw-w-full tw-flex-row">
                      <input type={`${getToggle1? "password":"text"}`} class="form-control tw-w-[87%] tw-border-2 tw-border-e-0 tw-rounded-lg tw-rounded-e-none tw-border-[#BABABA] tw-text-base" id="password" placeholder='Password' required/>
                  ...
                  <div class="tw-flex tw-w-full tw-flex-col tw-py-2">
                    <label for="validationCustom03" class="form-label">Password</label>
                    <div class="tw-flex tw-w-full tw-flex-row">
                      <input type={`${getToggle2? "password":"text"}`} class="form-control tw-w-[87%] tw-border-2 tw-border-e-0 tw-rounded-lg tw-rounded-e-none tw-border-[#BABABA] tw-text-base" id="password" placeholder='Password' required/>
                  ...
                  <div class="tw-flex tw-w-full tw-flex-col tw-py-2">
                    <label for="validationCustom03" class="form-label">Password</label>
                    <div class="tw-flex tw-w-full tw-flex-row">
                      <input type={`${getToggle3? "password":"text"}`} class="form-control tw-w-[87%] tw-border-2 tw-border-e-0 tw-rounded-lg tw-rounded-e-none tw-border-[#BABABA] tw-text-base" id="password" placeholder='Password' required/>
                  ...
                  <div class="tw-flex tw-w-full tw-flex-col tw-py-4 ">
                    <button type="button" class="tw-bg-[#458200] tw-w-full tw-h-12 tw-rounded-lg tw-text-white" data-bs-dismiss="modal">Ubah Password</button>
                  </div>
