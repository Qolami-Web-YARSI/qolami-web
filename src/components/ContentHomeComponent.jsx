...
const ContentHomeComponent = () => {
    ...
    const judul2 = ['PELAJAR', 'LATIHAN', 'UJIAN'];
        ...
        <>
            <div class="tw-bg-[#458200] tw-px-10 md:tw-ps-20 lg:tw-ps-28">
                <div class="tw-flex tw-justify-between tw-py-12 sm:tw-py-16 md:tw-py-20 lg:tw-py-24">
                    ...
                    <p class="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-font-bold tw-mb-7 md:tw-mb-16 lg:tw-mb-28 tw-text-white">SELAMAT DATANG</p>
                        ...
                        tw-pe-14 tw-text-justify">Bacaan Qolami atau seni tulisan khat adalah semi tulisan Arab yang khas dengan nilai estetika dan spiritual yang tinggi. Selain itu, seni tulisan khat merupakan bagian penting yang menjadi bagian integral dari warisan budaya Islam.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="tw-flex tw-flex-col tw-w-full tw-bg-[#FFF6D9] tw-py-20">
                <div class="tw-flex tw-justify-between">
                    <p class="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-font-bold tw-mx-auto tw-text-center">DIREKOMENDASIKAN OLEH</p>
                </div>
