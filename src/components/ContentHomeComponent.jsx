        ...
        <div className="tw-flex tw-justify-between tw-py-16 md:tw-py-14 lg:tw-py-20 tw-gap-4">
          ...
          <div className="tw-w-[100%] md:tw-w-[50%]">
            ...
            >
              ...
              tulisan khat adalah semi tulisan Arab yang khas dengan nilai
              estetika dan spiritual yang tinggi. Selain itu, seni tulisan khat
              merupakan bagian penting yang menjadi bagian integral dari warisan
              budaya Islam.
            </p>
          </div>
        </div>
