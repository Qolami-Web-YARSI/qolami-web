    ...
    return(
        <>
            <div class="tw-bg-[#458200] tw-size-full tw-px-10 md:tw-ps-20 lg:tw-ps-28">
                <div class="tw-flex tw-justify-between tw-py-12 sm:tw-py-16 md:tw-py-20 lg:tw-py-28">
                    ...
                    <div class="tw-w-[100%] md:tw-w-[50%]">
                        <p class="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-font-bold tw-mb-7 md:tw-mb-16 lg:tw-mb-24 tw-text-[#FFF6D9]">SELAMAT DATANG</p>
            ...
            <div class="tw-flex tw-flex-col tw-w-full tw-bg-[#FFF6D9] tw-py-20">
                <div class="tw-flex tw-justify-between">
                    <p class="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-py-6 tw-font-bold tw-mx-auto tw-text-center tw-text-[#009900]">DIREKOMENDASIKAN UNTUK</p>
                </div>
            ...
            <div class="tw-flex tw-flex-col tw-w-full tw-bg-[#FFF6D9]">
                <div class="tw-flex tw-justify-between">
                    <p class="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-font-bold tw-py-3 tw-pb-10 tw-mx-auto tw-text-center tw-text-[#009900]">FITUR-FITUR KURSUS</p>
                </div>
                <div class="tw-flex tw-justify-between">
