...
const ContentHomeComponent = () => {
    ...
    return(
        <>
            <div className="tw-bg-[#458200] tw-size-full tw-px-10 md:tw-ps-20 lg:tw-ps-28 tw-font-poppins">
                <div className="tw-flex tw-justify-between tw-py-12 sm:tw-py-16 md:tw-py-20 lg:tw-py-28">
                    <div className="tw-w-[0%] tw-hidden md:tw-w-[50%] md:tw-flex md:tw-justify-center">
                        <img src="logo-qolami.svg" className="tw-w-[0px] md:tw-w-[350px] lg:tw-w-[450px] tw-my-auto"/>
                    </div>
                    <div className="tw-w-[100%] md:tw-w-[50%]">
                        <p className="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-font-bold tw-mb-7 md:tw-mb-16 lg:tw-mb-24 tw-text-[#FFF6D9]">SELAMAT DATANG</p>
            ...
            <div className="tw-flex tw-flex-col tw-w-full tw-bg-[#FFF6D9] tw-py-20">
                <div className="tw-flex tw-justify-between">
                    <p className="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-py-1 md:tw-py-6 tw-font-bold tw-mx-auto tw-text-center tw-text-[#009900]">DIREKOMENDASIKAN UNTUK</p>
                </div>
                <div className="tw-flex tw-justify-between tw-border-b-4 tw-border-[#009900] tw-pb-10 md:tw-pb-32">
                    <div className="tw-w-[90%] lg:tw-w-[85%] tw-flex tw-flex-col md:tw-grid md:tw-grid-cols-3 tw-justify-around tw-m-auto md:tw-bg-[#C2EF90] tw-rounded-[30px] tw-my-20 tw-gap-10 md:tw-gap-0">
            ...
            <div className="tw-flex tw-flex-col tw-w-full tw-bg-[#FFF6D9]">
                <div className="tw-flex tw-justify-between">
                    <p className="tw-text-[28px] sm:tw-text-[35px] md:tw-text-[40px] lg:tw-text-[55px] tw-font-bold tw-py-1 md:tw-py-3 tw-pb-10 tw-mx-auto tw-text-center tw-text-[#009900]">FITUR-FITUR KURSUS</p>
                </div>
                <div className="tw-flex tw-justify-between">
                    <div className="tw-w-[90%] lg:tw-w-[70%] tw-flex tw-flex-col md:tw-grid md:tw-grid-cols-3 tw-justify-around tw-m-auto tw-my-20 tw-gap-10 tw-pb-10 md:tw-pb-28">
