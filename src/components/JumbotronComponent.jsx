...
const JumbotronComponent = () => {
    return(
        <>
            ...
            <div className="tw-h-full tw-pt-32 tw-bg-no-repeat tw-bg-contain tw-z-10 tw-p-10 md:tw-ps-24 md:tw-pe-16 tw-absolute">
            ...
            <div className="tw-h-full tw-pt-20 tw-bg-no-repeat tw-bg-contain tw-z-10 tw-p-12 md:tw-p-20 xl:tw-p-24 md:tw-ps-24 md:tw-pe-16 tw-bg-[#FFF6D9]">
                <div className="tw-flex tw-justify-between tw-opacity-0">
