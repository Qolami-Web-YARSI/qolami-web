                ...
                <div class="tw-flex tw-justify-between tw-opacity-0">
                    <div class="tw-w-[100%] md:tw-w-[50%] tw-text-[#009900] tw-py-24">
                        ...
                        <div class="tw-flex tw-justify-between tw-py-4 md:tw-py-5 lg:tw-py-9">
                            <button class="tw-bg-[#009900] tw-py-4 tw-px-3 sm:tw-px-5 tw-rounded-2xl tw-text-[#C2EF90] tw-font-bold tw-text-sm md:tw-text-md lg:tw-text-xl"><a href="/kursus">Mulai Belajar</a></button>
                        </div>
                    </div>
