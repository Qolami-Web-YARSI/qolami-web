...
const JumbotronComponent = () => {
    return(
        <>
            ...
            <div className="tw-h-full tw-pt-32 tw-bg-no-repeat tw-bg-contain tw-z-10 tw-p-10 md:tw-ps-24 md:tw-pe-16 tw-absolute tw-font-poppins">
                <div className="tw-flex tw-justify-between">
                    <div className="tw-w-[100%] md:tw-w-[50%] tw-text-[#009900] tw-py-24">
                        ...
                        <div className="tw-flex tw-justify-between tw-py-4 md:tw-py-5 lg:tw-py-9">
                            <button className="tw-bg-[#009900] tw-p-3 sm:tw-px-5 tw-rounded-2xl tw-text-[#C2EF90] tw-font-bold tw-text-sm md:tw-text-md lg:tw-text-xl hover:tw-bg-[#C2EF90] hover:tw-text-[#458200]"><a href="/kursus">Mulai Belajar</a></button>
                        </div>
                    </div>
                    <div className="tw-flex tw-w-[0%] md:tw-w-[50%]">
                        <div className="tw-flex tw-w-full">
