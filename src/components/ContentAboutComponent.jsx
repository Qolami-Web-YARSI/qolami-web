           ...
           <div className="tw-flex tw-flex-col tw-font-poppins">
                <div className="tw-flex tw-flex-col tw-gap-5 tw-pt-32 lg:tw-pt-36 tw-pb-14 tw-bg-[#C2EF90]">
                    ...
                    <p className="tw-text-[12px] sm:tw-text-[14px] md:tw-text-[18px] lg:tw-text-[23px] tw-text-[#009900]
                            ...
                            tw-font-poppins tw-mx-auto"><span 
                            className="tw-font-extrabold">Qolami</span> adalah sebuah platform pembelajaran Bahasa <br 
                            className='twi-hidden xl:tw-block'/> Arab yang interaktif dengan media gambar, audio, dan <br 
                ...
                {/* <div className="tw-bg-[#FFF6D9] tw-pt-24 md:tw-pt-20 lg:tw-pt-11">
                    ...
                    <div className="tw-grid lg:tw-w-[800px] 2xl:tw-w-[1300px] sm:tw-grid-cols-2 md:tw-grid-cols-2 
                    lg:tw-grid-cols-4 tw-px-5 sm:tw-px-16 md:tw-px-24 lg:tw-px-0 tw-pt-2 tw-pb-14 tw-mx-auto">
                ...
                <div className="tw-flex tw-gap-0 tw-py-14 tw-px-10 sm:tw-px-20 2xl:tw-px-20 tw-bg-[#FFF6D9] tw-justify-center">
                    <div className="tw-flex tw-flex-col tw-w-[80%] md:tw-w-[50%] lg:tw-w-[40%] 2xl:tw-w-[700px] tw-gap-2 md:tw-gap-3 tw-mx-auto sm:tw-mx-0">
                        <div className='tw-flex tw-flex-col tw-ps-4'>
                            ...
                            tw-font-bold tw-text-center sm:tw-text-start tw-font-poppins">TIM PENGEMBANG</p>
                            <p className='tw-text-center sm:tw-text-start tw-my-2 tw-text-[#458200] tw-text-[16px] sm:tw-text-[15px] 
                            md:tw-text-[18px] lg:tw-text-[20px] tw-py-2'> © 2024, ART Team</p>
                            <p className='tw-text-center sm:tw-text-start tw-text-[#009900] tw-text-[16px] sm:tw-text-[15px] 
                            md:tw-text-[18px] lg:tw-text-[25px] tw-font-normal tw-font-poppins'>Angga Aditya Putra Pratama</p>
                            <p className='tw-text-center sm:tw-text-start tw-text-[#009900] tw-text-[16px] sm:tw-text-[15px] 
                            md:tw-text-[18px] lg:tw-text-[25px] tw-font-normal tw-font-poppins'>Rizal Abimanyu</p>
                            <p className='tw-text-center sm:tw-text-start tw-text-[#009900] tw-text-[16px] sm:tw-text-[15px]
                             md:tw-text-[18px] lg:tw-text-[25px] tw-font-normal tw-font-poppins'>Tara Thania Anantha</p>
                        </div>
                        <div className='tw-flex tw-flex-col tw-gap-0'>
                            <p className="tw-text-[20px] sm:tw-text-[25px] md:tw-text-[35px] lg:tw-text-[45px] 
                            tw-text-[#009900] tw-font-bold tw-pt-5 tw-text-center sm:tw-text-start tw-font-poppins tw-ps-4">SOSIAL MEDIA</p>
                            <div className='tw-flex tw-justify-center sm:tw-justify-start tw-gap-3'>
                                <a href="https://www.youtube.com/@qolamichanel9019" target="_blank" 
                                className='tw-flex'><img className=' tw-my-auto tw-drop-shadow-[0_5px_5px_rgba(0,0,0,0.3)]' src="yt.svg" alt="yt_qolami"/></a>
                                <a href="https://www.instagram.com/metodeqolami/" target="_blank" 
                                className='tw-flex'><img className=' tw-my-auto tw-drop-shadow-[0_5px_5px_rgba(0,0,0,0.3)]' src="ig.svg" alt="ig_qolami"/></a>
                                <a href="https://www.tiktok.com/@metode_qolami" target="_blank" 
                                className='tw-flex'><img className='tw-my-auto tw-drop-shadow-[0_5px_5px_rgba(0,0,0,0.3)]' src="tiktok.svg" alt="tiktok_qolami"/></a>
                            </div>
                        </div>
                    </div>
