                    ...
                    tempUnlock[b] || tempToken  ? (
                        <div key={a.id}>
                            <Link to={`/kursus/${a.id}`} key={a.id}>
                                <div className={`tw-flex tw-flex-col tw-font-poppins tw-rounded-[20px] md:tw-rounded-[30px] tw-shadow-[0_4px_5px_0px_rgba(0,0,0,0.3)] tw-cursor-pointer tw-grayscale-0`}>
