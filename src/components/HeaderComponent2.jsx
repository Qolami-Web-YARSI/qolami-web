...
const HeaderComponent2 = () => {
    ...
    //const [getNama, setNama] = useState(localStorage.getItem('namaDepan')+" "+localStorage.getItem('namaBelakang'))
    //const [getGambar, setGambar] = useState(localStorage.getItem('gambarProfile'))
                    ...
                    <div className="tw-hidden md:tw-flex tw-flex-row tw-justify-end tw-gap-2 tw-w-[50%] md:tw-w-[30%] tw-cursor-pointer tw-me-10">
                        <div className="md:tw-flex tw-my-auto tw-gap-3 tw-text-[#009900] hover:tw-text-black">
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#editProfileModal">
                                <img src={data && data.gambarProfile} className="tw-size-[50px] tw-my-auto tw-rounded-full tw-border-black"/>
                            </button>
                        </div>
                    </div>
