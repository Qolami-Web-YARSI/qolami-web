            ...
            <header class="tw-border-b-2 tw-border-[#009900] tw-fixed tw-w-full tw-z-20">
                <nav class="tw-flex tw-bg-[#FFF6D9] tw-justify-between tw-py-4 tw-px-7">
                    ...
                    <div class="tw-hidden md:tw-flex tw-flex-row tw-justify-end tw-gap-2 tw-w-[50%] md:tw-w-[30%]">
                        ...
                        <button type="button" class="tw-bg-[#458200] hover:tw-bg-[#C2EF90] tw-px-5 tw-my-5 tw-rounded-full tw-font-bold tw-text-[#C2EF90] hover:tw-text-black tw-text-[15px] lg:tw-text-[20px] tw-text-right" data-bs-toggle="modal" data-bs-target="#daftarModal">Daftar</button>
                    </div>
