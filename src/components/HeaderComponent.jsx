            ...
            <header class="tw-border-b-2 tw-border-[#009900]">
                <nav class="tw-flex tw-bg-[#FFF6D9] tw-justify-between tw-p-2 tw-px-5">
                    ...
                    <div class="tw-hidden md:tw-flex tw-flex-row tw-justify-end tw-gap-2 tw-w-[50%] md:tw-w-[30%]">
                        <button type="button" class="tw-mx-3 lg:tw-mx-7 tw-font-bold tw-text-[#009900] hover:tw-text-black tw-text-[15px] lg:tw-text-[20px] tw-text-right" data-bs-toggle="modal" data-bs-target="#masukModal">Masuk</button>
                        <button type="button" class="tw-bg-[#458200] hover:tw-bg-[#C2EF90] tw-px-7 tw-my-3 tw-rounded-full tw-font-bold tw-text-[#C2EF90] hover:tw-text-black tw-text-[15px] lg:tw-text-[20px] tw-text-right" data-bs-toggle="modal" data-bs-target="#daftarModal">Daftar</button>
                    </div>
